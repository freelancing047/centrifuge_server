...
# Centrifuge modification: Always use our own JRE. Do not use existing values of
# environment variables for Tomcat or Java.
...
# CENTRIFUGE SERVER - cd to CATALINA_HOME so that is the root directory
cd $CATALINA_HOME
