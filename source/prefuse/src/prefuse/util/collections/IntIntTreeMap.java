...
public class IntIntTreeMap extends AbstractTreeMap implements IntIntSortedMap {
     ...
     */
    synchronized public int remove(int key) {
    ...
    synchronized public int remove(int key, int val) {
        // remove the last instance with the given key
    ...
    synchronized public LiteralIterator keyIterator() {
