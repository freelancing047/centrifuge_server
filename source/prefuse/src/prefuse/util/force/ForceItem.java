...
public class ForceItem implements Cloneable {
	...
	{
		public static Predicate<ForceItem> IsLocked = new Predicate<ForceItem>() {

			@Override
			public boolean apply(ForceItem input) {
				return input.locked;
			}
		};
		
		public static Predicate<ForceItem> IsNotLocked = Predicates.not(IsLocked);
	}
    ...
    public ForceItem() {
        ...
        k = new float[4][2]; // { { 0.f, 0.f }, { 0.f, 0.f }, { 0.f, 0.f }, { 0.f, 0.f } };
        l = new float[4][2];// { { 0.f, 0.f }, { 0.f, 0.f }, { 0.f, 0.f }, { 0.f, 0.f } };
    }
