...
//        double radius = 0;
//        NodeItem srcnode = (NodeItem)e.getSourceNode();
//        int srcSprings = srcnode.getDegree() - 1;
////        double srcAngle = 360/srcSprings;
//        
//        NodeItem targetnode = (NodeItem)e.getTargetNode();
//        int tgSprings = targetnode.getDegree() - 1;
////        double tgAngle = 360/tgSprings;
//
//        // distance along circumference at given angle (t): d=2*pi*r*(t/360)
//        // Rework formula to determine radius (r) given that we want the
//        // distance to be large enough to no overlap node of base size 40
//        if (srcSprings > 0) {
//            radius += (40/2 + 2)/(2*Math.PI)*(360/srcSprings);
//        }
//        
//        if (tgSprings > 0) {
//            radius += (40/2 + 2)/(2*Math.PI)*(360/tgSprings);
//        }
//        
//        if (radius > 0  ) {
//            return (float) radius;
