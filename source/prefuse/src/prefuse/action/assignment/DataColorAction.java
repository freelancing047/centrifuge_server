...
public class DataColorAction extends ColorAction {
   private static final Logger LOG = LogManager.getLogger(DataColorAction.class);
    ...
    protected void setup() {
        ...
        if ( m_scale == Constants.QUANTILE_SCALE && m_bins <= 0 ) {
           LOG.warn("Can't use quantile scale with no binning. " +
    ...
    public int getColor(VisualItem item) {
        ...
        if ( o != null ) {
            if ( o instanceof ColorAction ) {
               ...
               LOG.warn("Unrecognized Object from predicate chain.");
            }
        }
