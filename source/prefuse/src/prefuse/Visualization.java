 ...
 */
@SuppressWarnings({"all", "unchecked", "JavaDoc", "allJavadoc", "unused", "ForLoopReplaceableByForEach", "WhileLoopReplaceableByForEach", "SimplifiableConditionalExpression", "StringEquality", "ThrowableResultOfMethodCallIgnored"})
public class Visualization {
    ...
    public Iterator visibleItems() {
        return items(new VisiblePredicate());
    }
    ...
    public Iterator visibleItems(String group) {
        return items(group, new VisiblePredicate());
    }
