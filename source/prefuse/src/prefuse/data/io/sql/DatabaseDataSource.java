...
public class DatabaseDataSource {
   private static final Logger LOG = LogManager.getLogger(DatabaseDataSource.class);
    ...
    private ResultSet executeQuery(String query) throws SQLException {
        ...
        LOG.info("External query processing completed: "
        ...
        throws DataIOException
    {
        ...
        try {
            ...
            if ( t == null ) {
                ...
                if ( key != null ) {
                    try {
                        t.index(key);
                        LOG.info("Indexed field: "+key);
                    } catch ( Exception e ) {
                       LOG.warn("Error indexing field: "+key);
                    }
                }
            }
        ...
        // clock out
        long time = System.currentTimeMillis()-timein;
        LOG.info("Internal query processing completed: "+count+" rows, "
                + (time/1000) + "." + (time%1000) + " seconds.");
