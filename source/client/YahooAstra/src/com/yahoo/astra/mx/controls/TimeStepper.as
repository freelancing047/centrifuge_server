...
package com.yahoo.astra.mx.controls
{
	...
	/**
	 * If true, the milliseconds value will be displayed.
	 * 
	 * @default true
	 */
	...
	//--------------------------------------
		...
		override protected function createChildren():void
		{
			...
			if(!this.timeInput)
			{
				...
				this.timeInput.addEventListener(TimeInputEvent.MILLISECONDS_FOCUS_IN, timeInputUnitFocusInHandler);
		...
		protected function increment():void
		{
			...
			switch(this.focusedField)
			{
				...
				case TimeUnit.MILLISECONDS:
					var milliseconds:Number = value.getMilliseconds();
		...
		protected function timeInputUnitFocusInHandler(event:TimeInputEvent):void
		{
			switch(event.type)
			{
				...
				case TimeInputEvent.SECONDS_FOCUS_IN:
					...
					break;
				case TimeInputEvent.MILLISECONDS_FOCUS_IN:
					this.focusedField = TimeUnit.MILLISECONDS;
					break;
				default:
