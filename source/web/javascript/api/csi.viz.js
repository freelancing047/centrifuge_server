...
(function(root){
    ...
    var viz = root.viz ||
    {
        ...
        /**
         * @name csi.viz.addVisualization
         * @function
         * @description Adds the visualization object.
         * @param dvUuid        Dataview uuid.
         * @param worksheetUuid Worksheet uuid.
         * @param options      params of the request to server.
         * @since 1.2
         */
        addVisualization: function(dvUuid, worksheetUuid, vizDef, options){
            options = options || {};
            options.query = options.query || {};
            options.query.dvUuid = dvUuid;
            options.query.worksheetUuid = worksheetUuid;
            var payload = JSON.stringify(vizDef);
            options.data = payload;
            options.method = 'POST';
            options.contentType = "application/json";
            options.contentLength = payload.length;
            invokefn(viz, 'addVisualization', options);
        },
        ...
        /**
         * @name csi.viz.getUniqueVisualizationName
         * @function
         * @description Retrieves a unique name for the type of visualization .
         * @param dvid        Dataview uuid.
         * @param viztype     Visualization type
         * @since 1.2
         */
        getUniqueVisualizationName: function(dvid, type){
            options = {};
            options.query.uuid = dvid;
            var payload = JSON.stringify(type);
            options.data = payload;
            options.method = 'POST';
            options.contentType = "application/json";
            options.contentLength = payload.length;
            invokefn(viz, 'getUniqueVisualizationName', options);
        },
         ...
         * @since 1.2
         */
        saveSettings: function(dvid, isStructural, vizDef, options){
            options = options || {};
            options.query = options.query || {};
            options.query.dvUuid = dvid;
            options.query.isStructural = isStructural;
            var payload = JSON.stringify(vizDef);
            options.data = payload;
            options.method = 'POST';
            options.contentType = "application/json";
