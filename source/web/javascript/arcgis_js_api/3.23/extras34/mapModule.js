define([
    ...
    function featureLayerContextMenu(response) {
        ...
        var legendPosition = window.parent.getLegendPosition(vizid);
        if ((map.width - screenPoint.x > cmenu.scrollWidth) && legendPosition[0] - screenPoint.x > cmenu.scrollWidth){
        ...
        if (legendPosition[2] - screenPoint.x < cmenu.scrollWidth) {
            cmenu.style.left = (screenPoint.x + extentFunction.getNewPaddingLeft()) + "px";
        }
        if ((map.height - screenPoint.y > cmenu.scrollHeight) && legendPosition[1] - screenPoint.y > cmenu.scrollHeight) {
    ...
    function prepareLineDefinition(featureHash, linkHash, sourceGeometries, destinationGeometries, arr, a) {
        ...
        while (j < a.sourceObjectIds.length) {
            ...
            if (sourceObjectId == null) {} else if (destinationObjectId == null) {} else if (!(sourceObjectId in featureHash)) {} else if (!(destinationObjectId in featureHash)) {} else {
