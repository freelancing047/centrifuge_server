function BundleEntireGraphBySpec(vizuuid) {
	this.vizuuid = vizuuid;
}

BundleEntireGraphBySpec.prototype.doTask = function() {
	...
	csi.relgraph.bundleEntireGraphBySpec(window.dataview.myData.resultData.uuid, vizuuid, {
		onsuccess : doSuccess()
	});
}
