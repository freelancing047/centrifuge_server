    ...
    handle = {
        ...
        menuMouseleave: function(e) {
            ...
            if ($currentTrigger !== null)
            	$currentTrigger.data('contextMenu').$menu.trigger('contextmenu:hide');//Added this line additionally            	
        },
    ...
    switch (operation) {
        ...
        case 'destroy':
            if (!o.selector) {
                ...
                try {
                	console.log(menus[namespaces[o.selector]].$menu);
