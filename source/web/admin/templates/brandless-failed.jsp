...
<center>
                            ...
                            <div class="errorMessageDiv" id="errorMessageDiv" name="errorMessageDiv">
                                <table cellpadding="0" cellspacing="0" border="0" height="31">
                                    <tr height="31">
                                        <td>
                                         <center>
                                            	<a>Login failed.<br>Username/password do not match or username has expired.</a>
                                            </center>                                      
                                     </td>
                                    </tr>
                                </table>                       
 ...
 <table width="100%">    		<!-- Copy Right -->
		...
		<br><b><font face="Arial, Helvetica, sans-serif" size="1" color="#FFFFFF" >Version <%= BuildNumber.getVersion() %>, Build <%= BuildNumber.getBuildNumber() %></font></b><br /><b><font face="Arial, Helvetica, sans-serif" size="1" color="#FFFFFF" >COPYRIGHT &copy; 2012 CENTRIFUGE SYSTEMS, INC.  ALL RIGHTS RESERVED</font></b>
		</div>	
</table>
   </form>
