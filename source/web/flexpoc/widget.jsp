...
<%
 ...
 String flashVars = "dvUuid=" + dataViewId + "&template=" + template + "&tabIndex=" + tabIndex + "&params=" + queryParams +"&showOnlyOnce=true";
 flashVars += "&exportToANX=false";
...
if ( hasProductInstall && !hasRequestedVersion ) {
    ...
    AC_FL_RunContent(
            "src", "/Centrifuge/flex/CentrifugeWidget",
            "width", "100%",
            "height", "100%",
            "align", "middle",
            "id", "Centrifuge",
