...
<%
 ...
 String vizId  = (String) request.getParameter("vizUuid");
 
 String flashVars = "dvUuid=" + dataViewId + "&vizUuid=" + vizId;
%>
...
<script src="../resources/mapchart/mapchart.js" language="javascript"></script>
...
var alternateContent = 'Centrifuge requires Flash Player version 10 or higher. '
...
if ( hasProductInstall && !hasRequestedVersion ) {
    ...
    AC_FL_RunContent(
            "src", "/Centrifuge/flex/VisualizationWidget",
            "width", "100%",
            "height", "100%",
            "align", "middle",
            "id", "Centrifuge",
