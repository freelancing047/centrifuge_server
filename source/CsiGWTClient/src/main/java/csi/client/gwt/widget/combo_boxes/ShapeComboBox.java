...
import csi.client.gwt.widget.misc.ShapeAttribute;
 ...
 *
 */
public class ShapeComboBox extends ComboBox<ShapeType> {
    ...
    public ShapeComboBox() {
        ...
        new LabelProvider<ShapeType>() {
            ...
            public String getLabel(ShapeType item) {
                return ShapeAttribute.getInternationalizedShape(item);
            }
        });
        ...
        for (ShapeType df : ShapeType.nodeShapeWheel) {
            getStore().add(df);
        }
