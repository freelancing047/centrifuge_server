 ...
 */
public class OldExcelInstallWizard extends SpreadsheetInstallWizard {
    ...
    public OldExcelInstallWizard(WizardDialog priorDialogIn, UploaderControl controlIn,
                                 InstalledTable tableIn, String titleIn, String helpIn) {

        super(CsiFileType.OLD_EXCEL, priorDialogIn, controlIn, false, tableIn, titleIn, helpIn);
