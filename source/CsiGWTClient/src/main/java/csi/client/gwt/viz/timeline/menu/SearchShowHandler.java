...
public class SearchShowHandler<V extends Visualization, M extends AbstractMenuManager<V>> extends AbstractMenuEventHandler {

    public SearchShowHandler(V presenter, M menuManager) {
    ...
    public void onMenuEvent(CsiMenuEvent event) {
        ...
        if(getPresenter() instanceof Searchable) {
            ((Searchable)getPresenter()).showFind();
        }
    }
