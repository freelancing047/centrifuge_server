...
public class SharingAdmin {

    protected static final CentrifugeConstants _constants = CentrifugeConstantsLocator.get();

    static final String NO_GROUP_SELECTED = _constants.securityAdmin_SelectSharing();
    static final String ALL_GROUPS = _constants.securityAdmin_AllSharing();
    ...
    public SharingAdmin(GroupTab tabIn, SharedItems sharedIn) {
        ...
        _info = new GroupInfo(GroupType.SHARING, _shared);
        ...
        _tab.editButton.addClickHandler(handleAnyButton(new ClickHandler() {
            public void onClick(ClickEvent eventIn) {
                SharingInfoPopup myDialog = new SharingInfoPopup(_selectedGroupList.get(0), _shared);
        ...
        _tab.newButton.addClickHandler(handleAnyButton(new ClickHandler() {
            public void onClick(ClickEvent eventIn) {
                SharingInfoPopup myDialog = new SharingInfoPopup(null, _shared);
...
//                    disableGroupSelection();
    ...
    public void refreshGroups() {
        ...
        try {
            ...
            vortexFuture.execute(UserAdministrationServiceProtocol.class).retrieveGroups(GroupType.SHARING, myList);
    ...
    private void addGroup(Object dataIn) {
        ...
        if ((null != dataIn) && (dataIn instanceof GroupDisplay)) {
            ...
            if (GroupType.SHARING.equals(myGroup.getType())) {
                ...
                _shared.addGroup(GroupType.SHARING, myGroup.getName());
                _groupMap.put(myGroup.getName().toLowerCase(), myGroup);
        ...
        if ((null != _selectedGroupList) && (0 < _selectedGroupList.size())) {
            ...
            if (0 < myList.size()) {
                ...
                try {
                    ...
                    vortexFuture.execute(UserAdministrationServiceProtocol.class).deleteGroups(GroupType.SHARING, myList);
                    
                    vortexFuture.addEventHandler(handleGroupDeleteResponse);

                    _shared.deleteGroups(GroupType.SHARING, myList);
    ...
    private void requestData(String searchStringIn, String filterSelectionIn) {
        ...
        try {
            ...
            if ((null != filterSelectionIn) && (0 < filterSelectionIn.length())) {
                ...
                vortexFuture.execute(UserAdministrationServiceProtocol.class).searchGroupGroups(GroupType.SHARING, filterSelectionIn, searchStringIn);
            }
            else {
                
                vortexFuture.execute(UserAdministrationServiceProtocol.class).searchGroups(GroupType.SHARING, searchStringIn);
            }
    ...
    public void replaceGroupLists() {
        ...
        Collection<StringEntry> myList = _shared.getGroupList(GroupType.SHARING);
        ...
        if ((null != myList) && (0 < myList.size())) {
            ...
            if (_shared.provideSharing()) {
                ...
                for (StringEntry myGroup : myList) {
                    ...
                    if (!(_shared._adminGroup.equals(myGroupName)
                            || _shared._everyoneGroup.equals(myGroupName)
                            || _shared._securityGroup.equals(myGroupName))) {
        ...
        Map<String, StringEntry> myGoneGroups = _shared.getDeletedMap(GroupType.SHARING);
    ...
    private void refreshData() {
        ...
        _shared.refreshGroups(GroupType.SHARING);
    }
/*
