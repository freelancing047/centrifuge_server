...
public class GetStartedView extends Composite implements CsiLandingPage {
    ...
    interface SpecificUiBinder extends UiBinder<Widget, GetStartedView> {
    }
    ...
    public GetStartedView(DataViewPresenter dataViewPresenter) {
