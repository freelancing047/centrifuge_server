...
public class ZoomOutHandler implements VizButtonHandler, ClickHandler {
	private MapPresenter presenter;

	public ZoomOutHandler(MapPresenter presenter) {
	...
	public String getTooltipText() {
		return CentrifugeConstantsLocator.get().mapViewZoomOut();
	}
}
