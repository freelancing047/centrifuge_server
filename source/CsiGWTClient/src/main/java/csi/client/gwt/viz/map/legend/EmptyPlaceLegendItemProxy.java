...
public class EmptyPlaceLegendItemProxy extends PlaceLegendItemProxy {

    private static CentrifugeConstants i18n = CentrifugeConstantsLocator.get();
    
    public EmptyPlaceLegendItemProxy(PlaceLegendItem item, MapPresenter mapPresenter) {
    ...
    protected void createLabel() {
        ...
        label.setText(i18n.empty_string_label());
    }
