 ...
 */
public class XmlInstallWizard extends FileInstallWizard {
    ...
    public XmlInstallWizard(WizardDialog priorDialogIn, UploaderControl controlIn,
                            InstalledTable tableIn, String titleIn, String helpIn) {

        super(CsiFileType.XML, priorDialogIn, controlIn, tableIn, titleIn, helpIn);
