...
public class AssociationOverLimitLegendItemProxy extends Composite implements LegendItemProxy {
	...
	public AssociationOverLimitLegendItemProxy() {
		Row row = new Row();
        ...
        label.setText(CentrifugeConstantsLocator.get().tooManyAssociations());
        row.add(label);
        initWidget(row);
	}
