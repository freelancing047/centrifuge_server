...
import csi.client.gwt.viz.timeline.view.summary.drawing.SummaryFrame;
 ...
 */
public class SummaryTimelineView extends TimelineView<DetailedEventRenderable, SummaryEventRenderable, Axis, OverviewRenderable> {

    private TimelinePresenter presenter;
    private String limitMessage;
    private String emptyMessage = i18n.timelineNoResultsMessage();
    ...
    private List<SummaryEventRenderable> events = new ArrayList<SummaryEventRenderable>();
    private List<DetailedEventRenderable> detailedEvents = new ArrayList<DetailedEventRenderable>();
    ...
    interface SpecificUiBinder extends UiBinder<Widget, SummaryTimelineView> {
    }

    private static SpecificUiBinder uiBinder = GWT.create(SpecificUiBinder.class);

    public SummaryTimelineView(TimelinePresenter presenter) {
        super();
    ...
    public void render(List<DetailedEventRenderable> detailedRenderables, List<SummaryEventRenderable> renderables, List<Axis> axes, boolean drawNow) {
        this.events = renderables;
        this.detailedEvents = detailedRenderables;
        this.axes = axes;
    ...
    public void render() {
        ...
        timeline.setDetailedEvents(detailedEvents);
    ...
    @Override
    public void renderOverview(List<OverviewRenderable> summaryRenderables) {
    ...
    public void showEmpty() {
        this.events = new ArrayList<SummaryEventRenderable>();
        this.detailedEvents = new ArrayList<DetailedEventRenderable>();
    ...
    public void setTrackName(String _trackName) {
        ...
        breadcrumb.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                presenter.getEventBus().fireEvent(new TrackDrillEvent(null));
            }
        });

        drillBreadcrumb.add(breadcrumb);

        Breadcrumb trackBreadcrumb;
        if(_trackName.isEmpty()){
            trackBreadcrumb = new Breadcrumb("No Value");
        }else{
            trackBreadcrumb = new Breadcrumb(_trackName);
        }
