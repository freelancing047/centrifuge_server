 ...
 *
 */
public class RightGroupMapperCell<S extends SelectionDataAccess<?>, T extends SelectionDataAccess<?>>
    ...
    public void render(Cell.Context context, SelectionPair<S, T> value, SafeHtmlBuilder sb) {
        sb.append(template3.html(value.getRightGroupImageHtml(), value.getRightGroupDisplayName()));
    }
}
