...
public class NewPlaceLegendItemClickHandler implements ClickHandler {
	private MapPresenter mapPresenter;

	public NewPlaceLegendItemClickHandler(MapPresenter mapPresenter) {
	...
	public void onClick(ClickEvent event) {
		...
		mapPresenter.newPlaceClicked(selectionOperation.toString());
