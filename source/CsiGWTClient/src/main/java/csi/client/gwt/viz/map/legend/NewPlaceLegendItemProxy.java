...
public class NewPlaceLegendItemProxy extends Composite implements LegendItemProxy {
    ...
    private NewPlaceLegendItem item;
    private DivWidget iconWidget;

    NewPlaceLegendItemProxy(NewPlaceLegendItem item) {
