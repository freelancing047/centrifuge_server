...
public class MultiTypeLinkLegendItem extends Composite implements LegendItemProxy {
    public static final String CSI_INTERNAL_MULTITYPE = "csi.internal.multitype.link"; //NON-NLS
    private String typeName = CentrifugeConstantsLocator.get().multitype();

    public MultiTypeLinkLegendItem() {
        Row row = new Row();
        ...
        divWidget.getElement().getStyle().setBorderColor("#0F0");
