...
import csi.client.gwt.theme.editor.graph.nodes.NodeStyleView;
...
public class AssociationStyleFieldTab extends Composite {

    private static AssociationStyleFieldTabUiBinder uiBinder = GWT.create(AssociationStyleFieldTabUiBinder.class);

    interface AssociationStyleFieldTabUiBinder extends UiBinder<Widget, AssociationStyleFieldTab> {
    }
    ...
    private MapTheme currentTheme = null;
    private AssociationStyle currentStyle = null;
    private AssociationStyle alternateStyle = null;

    public AssociationStyleFieldTab() {
        ...
        nameColumn.setHeader(i18n.themeEditor_map_add_association_general_fieldname());
    ...
    public void display(AssociationStyle associationStyle) {
        ...
        selectedFieldsGrid.getStore().addAll(associationStyle.getFieldNames());
        name.setText(associationStyle.getName());
    ...
    public void save(AssociationStyle associationStyle) {
        associationStyle.getFieldNames().addAll(selectedFieldsGrid.getStore().getAll());
        associationStyle.setName(name.getValue());
    }
    ...
    private void placeItemCorrectly() {
        ...
        alternateStyle = (null != presenter) ? presenter.findAssociationConflict(typedText) : null;
        ...
        if (null != alternateStyle) {
            ...
            currentTheme.addAssociationStyle(currentStyle, typedText);
            alternateStyle = null;
            currentStyle = null;
            currentTheme = null;
        }
    ...
    private ClickHandler changeItemStyle = new ClickHandler() {
        ...
        public void onClick(ClickEvent event) {
            ...
            currentTheme.removeAssociationStyle(alternateStyle, typedText);
            selectedFieldsGrid.getStore().add(typedText);
            currentTheme.addAssociationStyle(currentStyle, typedText);
            alternateStyle = null;
            currentStyle = null;
