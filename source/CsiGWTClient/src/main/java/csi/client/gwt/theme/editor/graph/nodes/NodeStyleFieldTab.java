...
import csi.client.gwt.theme.editor.graph.links.LinkStyleView;
...
public class NodeStyleFieldTab extends Composite {

    private static NodeStyleFieldTabUiBinder uiBinder = GWT.create(NodeStyleFieldTabUiBinder.class);

    interface NodeStyleFieldTabUiBinder extends UiBinder<Widget, NodeStyleFieldTab> {
    }
    ...
    private NodeStyle alternateStyle = null;

    public NodeStyleFieldTab() {
        ...
        nameColumn.setHeader(i18n.nodeStyle_filedNames());
    ...
    public void display(NodeStyle nodeStyle) {
        ...
        selectedFieldsGrid.getStore().addAll(nodeStyle.getFieldNames());
        name.setText(nodeStyle.getName());
    ...
    public void save(NodeStyle nodeStyle) {
        nodeStyle.getFieldNames().addAll(selectedFieldsGrid.getStore().getAll());
        nodeStyle.setName(name.getValue());
    }
    ...
    private void placeItemCorrectly() {
        ...
        alternateStyle = (null != presenter) ? presenter.findNodeConflict(typedText) : null;
        ...
        if (null != alternateStyle) {
            ...
            currentTheme.addNodeStyle(currentStyle, typedText);
            alternateStyle = null;
            currentStyle = null;
            currentTheme = null;
        }
    ...
    private ClickHandler changeItemStyle = new ClickHandler() {
        ...
        public void onClick(ClickEvent event) {
            ...
            currentTheme.removeNodeStyle(alternateStyle, typedText);
            selectedFieldsGrid.getStore().add(typedText);
            currentTheme.addNodeStyle(currentStyle, typedText);
            alternateStyle = null;
            currentStyle = null;
