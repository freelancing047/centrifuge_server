...
public class AssociationStyleAppearanceTab extends Composite {

    private static AssociationStyleFieldTabUiBinder uiBinder = GWT.create(AssociationStyleFieldTabUiBinder.class);

    interface AssociationStyleFieldTabUiBinder extends UiBinder<Widget, AssociationStyleAppearanceTab> {
    }
...
//    Image styleCurrent;
    ...
    public AssociationStyleAppearanceTab() {
    ...
    public void display(AssociationStyle associationStyle) {
        ...
        color = associationStyle.getColor();
        setColor(ClientColorHelper.get().make(associationStyle.getColor()));
        width.setValue(""+associationStyle.getWidth()); 
    ...
    public void save(AssociationStyle associationStyle) {
        associationStyle.setColor(color);
        ...
        if(iconScaleString.isEmpty()){
            associationStyle.setWidth(1.0);
        } else {
            associationStyle.setWidth(Double.parseDouble(iconScaleString));
        }
    }
