...
public class HideMultitypeDecoratorHandler extends AbstractMenuEventHandler<MapPresenter, MapMenuManager> {
	public HideMultitypeDecoratorHandler(MapPresenter presenter, MapMenuManager menuManager) {
	...
	public void onMenuEvent(CsiMenuEvent event) {
		...
		vortexFuture.execute(MapActionsServiceProtocol.class).setMultitypeDecoratorShown(getPresenter().getDataViewUuid(), getPresenter().getVisualizationDef().getUuid(), false);
