...
public class AssociationLegendItemClickHandler implements ClickHandler {
	private MapPresenter mapPresenter;
    private String associationKey;
    
    public AssociationLegendItemClickHandler(MapPresenter mapPresenter, String associationKey) {
	...
	public void onClick(ClickEvent event) {
        ...
        mapPresenter.associationClicked(associationKey, selectionOperation.toString());
