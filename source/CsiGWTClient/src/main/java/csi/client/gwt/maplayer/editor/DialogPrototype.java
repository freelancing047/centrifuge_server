...
public class DialogPrototype extends SizeProvidingModal {
    ...
    public DialogPrototype(String deleteButtonTextIn, String saveButtonTextIn, String cancelButtonTextIn, CanBeShownParent parentIn) {
        super(parentIn);
        init(deleteButtonTextIn, saveButtonTextIn, cancelButtonTextIn);
    }

    public DialogPrototype(String deleteButtonTextIn, String saveButtonTextIn, String cancelButtonTextIn) {
        super();
        init(deleteButtonTextIn, saveButtonTextIn, cancelButtonTextIn);
    }
    ...
    public void hideOnAction() {
        getDeleteButton().addClickHandler(event -> { hide(); });
        getSaveButton().addClickHandler(event -> { hide(); });
    }
    ...
    private void init(String deleteButtonTextIn, String saveButtonTextIn, String cancelButtonTextIn) {
        // Adds the footer.
        ...
        _buttonList.add(buttonSave);
        _buttonList.add(buttonDelete);
        buttonDelete.setText(deleteButtonTextIn);
        buttonSave.setText(saveButtonTextIn);
