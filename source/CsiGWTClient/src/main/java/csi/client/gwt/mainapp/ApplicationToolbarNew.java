...
public class ApplicationToolbarNew extends AbstractApplicationToolbar {
    ...
    private static ApplicationToolbarNew at;
    private static ApplicationToolbarNew.MyUiBinder uiBinder = GWT.create(ApplicationToolbarNew.MyUiBinder.class);
    ...
    public static ApplicationToolbarNew getInstance() {
        if (at == null) {
            at = new ApplicationToolbarNew();
        }
        return at;
    }
    ...
    public void finalizeMenus(UserSecurityInfo userInfoIn) {
        ...
        caret.getStyle().setProperty("borderTopColor", "#226894");
        caret.getStyle().setProperty("borderBottomColor", "#226894");
    ...
    private void createDataviewDropdown(DataView dataViewIn) {
        ...
        if(!WebMain.getClientStartupInfo().getFeatureConfigGWT().isUseNewLogoutPage()) {
            ...
            shareDataView.setVisible(false);
            manageLinkupDef.setVisible(false);
        }
    ...
    interface MyUiBinder extends UiBinder<Widget, ApplicationToolbarNew> {
    }
