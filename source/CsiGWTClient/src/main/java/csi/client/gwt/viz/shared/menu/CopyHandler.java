...
public class CopyHandler<T extends Visualization> extends AbstractMenuEventHandler<T, AbstractMenuManager<T>> {

	public CopyHandler(T presenter, AbstractMenuManager<T> menuManager) {
	...
	public void onMenuEvent(CsiMenuEvent event) {
		...
		worksheetPresenter.openCopyDialog(worksheetPresenter, getPresenter().getUuid());
