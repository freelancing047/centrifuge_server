 ...
 *
 */
public class ColumnNameCell extends AbstractCell<InstalledColumn> {
    ...
    public ColumnNameCell(ListStore<? extends DataStoreColumnAccess> dataStoreIn, FieldDefComboBox comboBoxIn, String defaultTextIn) {
        super();
    ...
    @Override
    public void render(com.google.gwt.cell.client.Cell.Context contextIn, InstalledColumn itemIn, SafeHtmlBuilder builderIn) {
        ...
        if (itemIn != null) {
            FieldType myFieldType = FieldType.COLUMN_REF;
            CsiDataType myDataType = itemIn.getType();
