 ...
 */
public class DownButton extends FlowPanel {
    ...
    public DownButton(ClickHandler handlerIn) {
        super();
        _this = this;
        _handler = handlerIn;
        getElement().setInnerSafeHtml(cellTemplate.templateOrder(SortResource.IMPL.downButtonIcon().getSafeUri()));
