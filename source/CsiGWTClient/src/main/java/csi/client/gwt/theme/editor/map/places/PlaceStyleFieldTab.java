...
public class PlaceStyleFieldTab extends Composite {

    private static PlaceStyleFieldTabUiBinder uiBinder = GWT.create(PlaceStyleFieldTabUiBinder.class);

    interface PlaceStyleFieldTabUiBinder extends UiBinder<Widget, PlaceStyleFieldTab> {
    }
    ...
    private PlaceStyle alternateStyle = null;

    public PlaceStyleFieldTab() {
        ...
        nameColumn.setHeader(i18n.themeEditor_map_place_style_general_fieldname());
    ...
    public void display(PlaceStyle placeStyle) {
        ...
        selectedFieldsGrid.getStore().addAll(placeStyle.getFieldNames());
        name.setText(placeStyle.getName());
    ...
    public void save(PlaceStyle placeStyle) {
        placeStyle.getFieldNames().addAll(selectedFieldsGrid.getStore().getAll());
        placeStyle.setName(name.getValue());
    }
    ...
    private void placeItemCorrectly() {
        ...
        alternateStyle = (null != presenter) ? presenter.findPlaceConflict(typedText) : null;
        ...
        if (null != alternateStyle) {
            ...
            currentTheme.addPlaceStyle(currentStyle, typedText);
            alternateStyle = null;
            currentStyle = null;
            currentTheme = null;
        }
    ...
    private ClickHandler changeItemStyle = new ClickHandler() {
        ...
        public void onClick(ClickEvent event) {
            ...
            currentTheme.removePlaceStyle(alternateStyle, typedText);
            selectedFieldsGrid.getStore().add(typedText);
            currentTheme.addPlaceStyle(currentStyle, typedText);
            alternateStyle = null;
            currentStyle = null;
