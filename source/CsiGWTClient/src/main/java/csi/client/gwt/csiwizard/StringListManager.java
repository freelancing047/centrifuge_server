...
public class StringListManager implements HasHandlers {
    ...
    private TreeMap<String, Integer> _valueMap = null;
    ...
    //
    //
    public StringListManager(int widthIn, int heightIn, Comparator comparatorIn) {
        
        _handlerManager = new HandlerManager(this);

        _width = widthIn;
        _height = heightIn;
        _comparator = (null != comparatorIn) ? comparatorIn : StringUtil.getCaselessStringComparator();
    ...
    protected void initializeList() {
        ...
        if (null != _comparator) {
            ...
            _valueMap = new TreeMap<String, Integer>(_comparator);

        } else {

            _valueMap = new TreeMap<String, Integer>();
        }
    }
