 ...
 */
public interface VortexFilterChain {

    /**
     * Design pattern similar to Servlet filter. Call this to allow the request processing to move
     * on, otherwise by-pass and end.
