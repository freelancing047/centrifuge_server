...
/**
 * Created by centrifuge on 3/4/2016.
 */
public class CsiConnection implements Connection {
   private static final Logger LOG = LogManager.getLogger(CsiConnection.class);

   private static boolean _doDebug = LOG.isDebugEnabled();

    private Connection _connection;

    public CsiConnection(Connection connectionIn) {

        if (_doDebug) LOG.debug("> > > Create cache connection");
    ...
    public void release() throws SQLException {
        ...
        if (_doDebug) LOG.debug("< < < Release cache connection");
        _connection.close();
    }
    ...
    public void close() throws SQLException {
        ...
        // Close is accomplished by finalthread action of calling release().
    }
